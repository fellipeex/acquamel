...
const USER = require('../../views/routes/user.js');
const ENTRADA = require('../../views/routes/entrada.js');
const SAIDA = require('../../views/routes/saida.js');
const CAM = require('../../views/routes/caminhao.js');
const FUNC = require('../../views/routes/funcionario.js');
const CLIENTE = require('../../views/routes/cliente.js');
